...
export default function Stats() {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-[95%] h-[90%] border border-black bg-[#F3F3F3] text-[#000000] dark:text-[#FFFFFF] dark:bg-[#262B3C] dark:border-[#939B9F] rounded-2xl">
